...
typedef struct sll_s {
	...
	void (*destroy)(struct sll_s *this, void (*deallocate)(void *object)); /** Destroy the SLL completely, free node and all object storage */
	...
	sll_node_t *(*removeNodeMatchingObj)(struct sll_s *this, void *object, comparator compare);	/** Remove an SLL node matching 'object' in the SLL */
	...
	sll_node_t *(*removeMatchingNode)(struct sll_s *this, sll_node_t *node);	/** Remove the specified 'node' from the SLL */
	void *(*removeObjAtMatchingNode)(struct sll_s *this, sll_node_t *node);		/** Remove the specified 'node' from the SLL and return its content */
	...
	/** Place 'node' s.t. SLL nodes are always are sorted */
	void (*placeNode)(struct sll_s *this, sll_node_t *node, int (*compare)(void *obj1, void *obj2)); 
	/** -- END  Sort functions -- */


	/** -- BEGIN  Reverse functions -- */
...
/** Remove */
void *removeObject_sll(struct sll_s *this, void *object, comparator compare);
