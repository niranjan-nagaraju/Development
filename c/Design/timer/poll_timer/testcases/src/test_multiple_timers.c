...
int main(void)
{
	...
	poll_timer_t *timer1 = set_timer(10, 1, 10, 5, poll_timer_fn1, (void *)ops);

	/** Recur twice at 1 mins interval */
	poll_timer_t *timer2 = set_timer(60, 1, 2, 10, poll_timer_fn2, (void *)(&number));
