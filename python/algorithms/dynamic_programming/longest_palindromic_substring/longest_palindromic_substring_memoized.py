...
def longestPalindrome(s):
	def longestPalindrome_r(s, l, r):
		if memoization_table.has_key((l,r)):
			return memoization_table[(l,r)]

		if l+1 == r: # 2 letters
			memoization_table[(l,r)] = (l,r) if s[l] == s[r] else (l,l)
			return memoization_table[(l,r)]

		if s[l] == s[r]:
			if isPalindrome(s, l+1, r-1):
				# whole of s[l..r] is a palindrome
				memoization_table[(l,r)] = (l,r)
				return (l, r)
		...
		memoization_table[(l,r)] =  (ls, le) if (le-ls) >= (re-rs) else (rs, re)
		return memoization_table[(l,r)]

	memoization_table = {}
	for i in xrange(len(s)):
		memoization_table[(i,i)] = (i,i)
