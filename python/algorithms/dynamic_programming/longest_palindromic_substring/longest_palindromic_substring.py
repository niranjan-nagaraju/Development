...
def longestPalindrome(s):
	...
	for i in xrange(n):
		...
		sIdx, eIdx, curr_len = max_palindrome_len(s, i, n-1, palindromes_lookup_table)
		if curr_len > max_len:
			max_len = curr_len
			max_sIdx = sIdx
			max_eIdx = eIdx
...
if __name__ == '__main__':
	assert isPalindrome("ab", 0, 1) == False
	assert isPalindrome("ab", 0, 0) == True
	assert isPalindrome("ab", 1, 1) == True
	assert isPalindrome("abcbd", 1, 3) == True

	assert max_palindrome_len("abcd", 0, 3, {}) == (0, 0, 1)
	assert max_palindrome_len("abcbd", 1, 4, {}) == (1, 3, 3) # bcb
	assert max_palindrome_len("cbbd", 1, 3, {}) == (1, 2, 2) # bb
	assert max_palindrome_len("babad", 0, 4, {}) == (0, 2, 3) # bab
	assert max_palindrome_len("babad", 1, 4, {}) == (1, 3, 3) # aba
