    ...
    def longestCommonPrefix(self, strs):
        ...
        for s in strs:
            ...
            for prefix in prefixes:
                prefixCount = prefixCounts.get(prefix, 0)
                if prefixCount != i:
                    # The prefix is already behind word-count
                    # skip counting it as it doesn't prefix
                    # all of the words seen so far
                    continue
                prefixCounts[prefix] = prefixCount + 1
            i += 1
