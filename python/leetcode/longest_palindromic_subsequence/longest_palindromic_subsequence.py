...
if __name__ == '__main__':
	...
	assert s.longestPalindromeSubseq("underqualified") == 7 #deified
	assert  s.longestPalindromeSubseq("turboventilator") == 7 # rotator
	assert  s.longestPalindromeSubseq("r1a2c3e4c5a6r7") == 7 # racecar
