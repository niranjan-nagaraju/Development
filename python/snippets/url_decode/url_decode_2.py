...
def decode_url(encoded_string):
	...
	while i < len(encoded_string):
		if encoded_string[i] == ord('%'):
			...
			decoded.append(chr(encoded_string[i]))
		i += 1
...
if __name__ == '__main__':
	...
	assert decode_url(test_string) == 'GET /{"mac":"1A:2B:3C:4D:5E:6F", "status":true}'
	...
	assert decode_url(t2) == 'GET /{"mac":"1A:2B:3C:4D:5E:6F", "status":true, "epoch" : 12345678}'
